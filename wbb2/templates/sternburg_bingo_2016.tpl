...
<head>
	<title>$master_board_name | Sternburg Bingo 2016</title>
	$headinclude
	<style>
	.field {
					...
					<tr class="tablea_fc">
						<td align="left">
							<span class="smallfont">
								<b>
									<a href="index.php{$SID_ARG_1ST}">$master_board_name</a> &raquo; Sternburg Bingo 2016 v1
								</b>
							</span>
						</td>
					...
					<tr align="left">
						<td colspan="2" class="tablea" align="center">
							<span class="smallfont">
								...
								<a href="sternburg_bingo_2016.php?toggle_freigabe=1">&auml;ndern</a>
							</span>
						</td>
					</tr>
				</table>
			...
			<td align="left">
				<table cellpadding="4" cellspacing="1" border="0" style="width:100%" class="tableinborder">
					...
					<tr align="left">
						<td colspan="2" class="tablea" align="center">
							<span class="smallfont">
								<form action="./sternburg_bingo_2016.php" method="post">
